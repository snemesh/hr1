                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                            <div class="form-group">
                                <label class="control-label col-lg-3 col-md-4 col-sm-12 col-xs-12" for="first-name">Registred Name <span class="required">:</span>
                                </label>
                            ...
                            <div class="form-group">
                                <label for="middle-name" class="control-label col-lg-3 col-md-4 col-sm-12 col-xs-12">Salary</label>
                                <div class="col-lg-6 col-md-8 col-sm-12 col-xs-12">
                                    {!! Form::text('salary',$user->salary,['placeholder' => 'Enter your salary', 'class'=>'form-control', 'required'=>'required' ]) !!}
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="middle-name" class="control-label col-lg-3 col-md-4 col-sm-12 col-xs-12">Hourly rate</label>
                                <div class="col-lg-6 col-md-8 col-sm-12 col-xs-12">
                            ...
                            <div class="form-group">
                                <label for="middle-name" class="control-label col-lg-3 col-md-4 col-sm-12 col-xs-12">Comments:</label>
                                <div class="col-lg-6 col-md-8 col-sm-12 col-xs-12">
                                    <textarea class="form-control parsley" id="message"  name="comments" rows="4">{!! $salarycomment  !!}</textarea>
