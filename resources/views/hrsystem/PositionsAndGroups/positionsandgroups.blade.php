<div class="row">
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
        <div class="x_panel">
            ...
            <div class="x_content">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="col-lg-8"><p>Press <code>Add new</code> to add a new position</p></div>
                    </div>
                </div>
    ...
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
        <div class="x_panel">
            {{--<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">--}}
            <div class="x_title">
                <h2>List of GROUPS<small>You can edit it</small></h2>
                <ul class="nav navbar-right panel_toolbox">
                    <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a></li>
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false"><i class="fa fa-wrench"></i></a>
            ...
            <div class="x_content">
                ...
                <div class="table-responsive">
                    <table class="table table-striped jambo_table bulk_action" id="tblGroup">
                        <thead>
                        <tr class="headings">
                            <th><input type="checkbox" id="check-all" class="flat"></th>
                        ...
                        {!! Form::open(['route' => 'addgroup']) !!}
                        <tr>
                            <th>

                            </th>
                            <th colspan="1">
                                {!! Form::text('group', '',['placeholder' => 'new group', 'class'=>'form-control', 'required'=>'required' ]) !!}
                            </th>
                            <th>
                                <button type="submit" class="btn-danger btn" style="">Add new</button>
                            </th>
